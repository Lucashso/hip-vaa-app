  ...
  const items: MenuItem[] = [
    {
      ...
      caption: "Nome, CPF, telefone, endereço",
      onClick: () => {
        /* placeholder até página dedicada existir */
      },
    },
    {
      icon: "wallet",
      label: "Pagamentos",
      caption: "Plano, faturas, formas de pagamento",
      onClick: () => navigate("/plano"),
    },
    {
      icon: "bell",
      label: "Notificações",
      caption: "WhatsApp, e-mail, push",
      onClick: () => {
        /* placeholder */
      },
    },
    {
      icon: "logout",
      label: "Sair",
      caption: "Encerrar sessão neste dispositivo",
